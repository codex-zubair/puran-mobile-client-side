...
const SearchField = () => {
    ...
    const searchFiledHandler = (event)=> {
        ...
        // Sending search value for query to server.
        axios.get(`https://puran-mobile-server-side.vercel.app/search/?search=${search_text}`)
    ...
    return (
        <form onSubmit={searchFiledHandler} className='items-center my-0 bg-primary flex justify-center'>
